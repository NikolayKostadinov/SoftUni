...
public class MinHeap<E extends Comparable<E> & Modify<E>> implements Heap<E> {
    ...
    @Override
    public void decrease(E element, long score) {
        int index = this.elements.indexOf(element);
        this.elements.get(index).decrease(score);
        this.heapifyUp(index);
    }

    @Override
    public void increase(E element, long score) {
        int index = this.elements.indexOf(element);
        this.elements.get(index).increase(score);
